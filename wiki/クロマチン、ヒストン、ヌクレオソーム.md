...
ヌクレオソームは、約147bpのDNAと2コピーのヒストンとH2A/H2B/H3/H4で構成されるもの。(ヌクレオソームについては後述)
...
Histon Octamer (2つの H2A/H2B/H3/H4）を147bpのDNAが囲んで、円盤を形成している。
...
PCNAについては[真核生物の複製の始動](真核生物の複製の始動.md)を参照のこと。
